...
class Kodak24(data.Dataset):
    def __init__(self, root='/fred/oz410/project/IDN/InvNetworks/data/PhotoCD_PCD0992/'):
        self.root = root
        self.image_name = []
...
class MakeTrainSet(data.Dataset):
    def __init__(self, root="/fred/oz410/project/IDN/InvNetworks/data/JPEGImages/"):
        self.root = root
